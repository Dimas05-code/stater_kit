 @if (Session::has('succes'))
     <div class=" flex justify-center">
         <div id="toast-success"
             ...
             <div class="ms-3 text-sm font-normal">{{ Session::get('succes') }}</div>
             <button type="button"
                 ...
                 <div class="w-full md:w-1/2">
                     <form class="flex items-center" autocomplete="off">
                         ...
                         <div class="relative w-full">
                             ...
                             <input type="text" name='keywoard' id="simple-search"
                 ...
                 <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                     <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                         <tr>
                             ...
                             <th scope="col" class="px-4 py-3">Tittle</th>
                                 ...
                                 <td class="px-4 py-3 flex items-center justify-end">
                                     ...
                                     <div id="post-{{ $post->id }}-dropdown"
                                         ...
                                         <ul class="py-1 text-sm"
                                             ...
                                             <li>
                                                 <a href="{{ route('dashboard.edit', $post->slug) }}" type="button"
                                                     data-modal-target="updateProductModall"
                                                     data-modal-toggle="updateProductModall"
                                         ...
                                         <div class="relative p-4 w-full max-w-md max-h-full">
                                             ...
                                             <div
                                                 ...
                                                 <div class="flex justify-center items-center space-x-4">
                                                     ...
                                                     {{-- 
                                                     <a href="{{ url('/dashboard/destroy/' . $post->slug) }}"
                                                         class="py-2 px-3 inline-block text-sm font-medium text-center text-white bg-red-600 rounded-lg hover:bg-red-700 focus:ring-4 focus:outline-none focus:ring-red-300 dark:bg-red-500 dark:hover:bg-red-600 dark:focus:ring-red-900">
                                                         Eksperimen Hapus
                                                     </a> --}}
                                                 </div>
                                             </div>
